    ...
    <>
      ...
      <div className="bg-moana-blue py-14 text-white">
        <div className="container-moana text-center">
          <h1 className="font-display font-bold text-4xl md:text-5xl mb-3">Quiénes Somos</h1>
          <p className="text-white/80 text-lg max-w-2xl mx-auto">
            Más de 10 años llevando familias y parejas a vivir experiencias únicas en Búzios y el mundo.
          </p>
        </div>
      </div>

      {/* About sections */}
      {NOSOTROS.map(({ titulo, texto, imagen }, i) => (
        <section key={i} className={i % 2 === 0 ? 'section-white' : 'section-cream'}>
          <div className={`container-moana grid grid-cols-1 lg:grid-cols-2 gap-10 items-center ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
            <div className={i % 2 !== 0 ? 'lg:order-2' : ''}>
              ...
              <p className="text-moana-gray leading-relaxed">{texto}</p>
            </div>
      ...
      <section className="section-pale-blue">
        <div className="container-moana">
          <div className="text-center mb-10">
            ...
            <p className="section-subtitle">El equipo humano detrás de cada viaje</p>
          </div>
      ...
      <section className="section-blue">
        <div className="container-moana text-center">
          <h2 className="font-display font-bold text-3xl mb-4">¿Querés viajar con nosotros?</h2>
