    ...
    <>
      <div className="bg-moana-blue py-14 text-white">
        <div className="container-moana text-center">
          <h1 className="font-display font-bold text-4xl md:text-5xl mb-3">{t('contacto_title')}</h1>
          <p className="text-white/80 text-lg max-w-xl mx-auto">{t('contacto_subtitle')}</p>
        </div>
      </div>
        ...
        <div className="container-moana grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a href="tel:+5522998090599" className="card p-4 flex items-center gap-4 hover:shadow-card-hover transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-moana-gray">+55 22 99809-0599</p>
                </div>
              </a>
              ...
              <a href="mailto:reservas@moanaturismo.com" className="card p-4 flex items-center gap-4 hover:shadow-card-hover transition-shadow">
                ...
                <div>
                  <p className="font-semibold text-moana-blue text-sm">{t('contacto_email_label')}</p>
              ...
              <a href="https://instagram.com/moanaturismo.oficial" target="_blank" rel="noreferrer"
                ...
                <div>
                  <p className="font-semibold text-moana-blue text-sm">{t('contacto_insta_label')}</p>
              ...
              <div className="card p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-moana-blue text-sm">{t('contacto_horarios_label')}</p>
                  <p className="text-moana-gray">{t('contacto_horarios_valor')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card p-8 flex flex-col items-center justify-center text-center">
            ...
            <a
              href="https://wa.me/5522998090599?text=Hola%20Moana!%20Quiero%20consultar%20sobre%20un%20viaje%20%F0%9F%8C%8A"
              target="_blank"
              rel="noreferrer"
            ...
            <p className="text-xs text-moana-gray mt-3">{t('contacto_wa_note')}</p>
          </div>
        </div>
      </section>
    </>
