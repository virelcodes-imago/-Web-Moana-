export default function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/5522998090599?text=Hola%20Moana!%20Quiero%20consultar%20sobre%20viajes%20%F0%9F%8C%8A"
      target="_blank"
      rel="noreferrer"
      aria-label="Consultar por WhatsApp"
      className="fixed bottom-6 right-6 z-40 w-16 h-16 bg-[#25D366] hover:bg-[#1DAA57] rounded-full
                 flex items-center justify-center shadow-xl hover:shadow-2xl hover:scale-110
